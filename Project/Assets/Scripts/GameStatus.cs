...
public class GameStatus : MonoBehaviour
{
    ...
    public static float[] GAIN_REPAIRMENT_IRON = new float[3] { 0.33f, 0.3f, 0.3f };
    public static float[] GAIN_REPAIRMENT_PLANT = new float[3] { 0.05f, 0.05f, 0.06f };

    // 적의 우주선 손상 대미지
    public static float[] DAMAGEENEMY = new float[3] { 0.01f, 0.01f, 0.01f };

    // 철광석, 사과, 식물을 운반했을 때 각각의 체력 소모 정도.
    public static float[] CONSUME_SATIETY_IRON = new float[3] { 0.02f, 0.03f, 0.03f };
    ...
    public static float[] REGAIN_SATIETY_PLANT = new float[3] { 0.2f, 0.15f, 0.2f }; // 0.2->0.3
